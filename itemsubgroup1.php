...
$result=mysql_query("SELECT count(*) AS total FROM itmgrp1");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM itmgrp1 ORDER BY gp1 Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "itemsubgroup1.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="edititemsubgroup1.php" style="margin-left:10%; font-size:18px;">New Item Sub Group 1</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;">
										<a href="edititemsubgroup1.php?gp1=<?=$gp1?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delitemsubgroup1.php?gp1=<?=$gp1?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
