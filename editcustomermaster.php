...
$ledgertypesel = "4310000";
	...
	if(isset($_POST['btnsav']))
	{
		...
		if($a==1)
		{
			?><script>alert("Record Inserted Succssfully.....!"); location.replace("customermaster.php"); </script><?php
		}
		else
		{
			?><script>alert("Record Not Inserted.....!"); location.replace("customermaster.php"); </script><?php
		}
	}
	else if(isset($_POST['btnupd']))
	{
		...
		if($b==1)
		{
			?><script>alert("Record Updated Succssfully.....!"); location.replace("customermaster.php");</script><?php
		}
		else
		{
			?><script>alert("Record Not Updated.....!"); location.replace("customermaster.php");</script><?php
		}
	}
