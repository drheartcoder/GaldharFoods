				...
				<table border="1" cellspacing="0" cellpadding="5" width="100%" align="center">
					<thead>
						<tr bgcolor="grey" align="center" style="color:white;">
							<th width="8%;">ID</th>
							<th width="46.5%;">Description</th>
							<th width="9.5%;">Prefix</th>
							<th width="7.5%;">Start Form</th>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							?>
								<tr align="center" class="<?php echo $class; ?>">
									<td width="8%;"><?php echo $VOU_SRNO; ?></td>
									<td width="50%;"><?php echo $VOU_TYPEDESC?></td>
									<td width="10%;"><?php echo $VOU_PRNPRFX?></td>
									<td width="8%;"><?php echo $VOU_STARTNO?></td>
									<td width="12%;">
										<a href="edituservouchersetup.php?VOU_SRNO=<?php echo $VOU_SRNO?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deluservouchersetup.php?VOU_SRNO=<?php echo $VOU_SRNO?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							<?
						}
