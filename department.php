...
$result=mysql_query("SELECT count(*) AS total FROM deptmst");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM deptmst ORDER BY id Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "department.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editdepartment.php" style="margin-left:10%; font-size:18px;">New Department Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;">
										<a href="editdepartment.php?id=<?=$id?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deldepartment.php?id=<?=$id?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
