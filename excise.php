...
$result=mysql_query("SELECT count(*) AS total FROM excise");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM excise ORDER BY id Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editexcise.php" style="margin-left:10%; font-size:18px;">New Excise Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;"><?=$ch_head?></td>
									<td width="5%;"><?=$ed?></td>
									<td width="12%;">
										<a href="editexcise.php?id=<?=$id?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delexcise.php?id=<?=$id?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
