...
$result=mysql_query("SELECT count(*) AS total FROM transporter");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM transporter ORDER BY id Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "transporter.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="edittransporter.php" style="margin-left:10%; font-size:18px;">New Transporter Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="10%;"><?=$city?></td>
									<td width="10%;">
										<a href="edittransporter.php?id=<?=$id?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deltransporter.php?id=<?=$id?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
