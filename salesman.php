...
$result=mysql_query("SELECT count(*) AS total FROM salesman");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM salesman ORDER BY code Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "salesman.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editsalesman.php" style="margin-left:10%; font-size:18px;">New Salesman Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;">
										<a href="editsalesman.php?code=<?=$code?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delsalesman.php?code=<?=$code?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
