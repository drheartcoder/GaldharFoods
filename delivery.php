...
$result=mysql_query("SELECT count(*) AS total FROM delivery");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM delivery ORDER BY id Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "delivery.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editdelivery.php" style="margin-left:10%; font-size:18px;">New Delivery Master</a>
			<span style="float:right; margin-right:10%; font-delivery:18px;">
				Enter Name  : 
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;">
										<a href="editdelivery.php?id=<?=$id?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deldelivery.php?id=<?=$id?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
