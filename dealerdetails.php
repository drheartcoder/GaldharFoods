...
$result=mysql_query("SELECT count(*) AS total FROM acmst");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM acmst where custid ORDER BY acid LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	...
	<body onLoad="searchelement('ac_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editdealerdetails.php" style="margin-left:10%; font-size:18px;">Add Dealer Record</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="10%;">
										<a href="editdealerdetails.php?acid=<?=$acid?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deldealerdetails.php?acid=<?=$acid?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
