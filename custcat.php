...
$result=mysql_query("SELECT count(*) AS total FROM custcat");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM custcat ORDER BY catcd Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "custcat.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editcustcat.php" style="margin-left:10%; font-size:18px;">New Customer Catagory</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									<td width="10%;"><?=$catcd?></td>
									<td width="50%;"><?=$catdesc?></td>
									<td width="12%;">
										<a href="editcustcat.php?catcd=<?=$catcd?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delcustcat.php?catcd=<?=$catcd?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
