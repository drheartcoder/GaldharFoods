...
$result=mysql_query("SELECT count(*) AS total FROM uom");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM uom ORDER BY uomid Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="edituom.php" style="margin-left:10%; font-size:18px;">New UOM Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									<td width="10%;"><?=$uomid?></td>
									<td width="50%;"><?=$uom?></td>
									<td width="12%;">
										<a href="edituom.php?uomid=<?=$uomid?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="deluom.php?uomid=<?=$uomid?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
