...
include 'session.php'; 
	...
	if(isset($_POST['btnsav']))
	{
		...
		{
			?>
				<script>alert("Record Inserted Succssfully.....!"); location.replace("dealerdetails.php"); </script>
			<?php
		}
		else
		{
			?>
				<script>alert("Record Not Inserted.....!"); location.replace("dealerdetails.php"); </script>
			<?php
		}
	}
	else if(isset($_POST['btnupd']))
	{
		...
		{
			?>
				<script>alert("Record Updated Succssfully.....!"); location.replace("dealerdetails.php");</script>
			<?php
		}
		else
		{
			?>
				<script>alert("Record Not Updated.....!"); location.replace("dealerdetails.php");</script>
			<?php
		}
	}
