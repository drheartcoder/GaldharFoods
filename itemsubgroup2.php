...
$result=mysql_query("SELECT count(*) AS total FROM itmgrp2");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM itmgrp2 ORDER BY gp1 Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	<head>
		...
		function searchelement(searchFld)
		{
			...
			{	
				...
				var fn = "itemsubgroup2.php?mt_head="+xt1;
				x.open("GET",fn);
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="edititemsubgroup2.php" style="margin-left:10%; font-size:18px;">New Item Sub Group 2</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									<td width="10%;"><?=$gp1?></td>
									<td width="50%;"><?=$grpnm1?></td>
									<td width="12%;">
										<a href="edititemsubgroup2.php?gp1=<?=$gp1?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delitemsubgroup2.php?gp1=<?=$gp1?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
