...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM team ORDER BY id Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editteam.php" style="margin-left:10%; font-size:18px;">New Team Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									...
									<td width="12%;">
										<a href="editteam.php?id=<?=$id?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delteam.php?id=<?=$id?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
