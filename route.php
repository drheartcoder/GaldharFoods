...
$result=mysql_query("SELECT count(*) AS total FROM routemast");
...
include("dbconnect.php");
$result = mysql_query("SELECT * FROM routemast ORDER BY locncd Asc LIMIT $from , $perPage");
?>
<!--Pageing Ends-->
...
<html>
	...
	<body onLoad="searchelement('mt_head')">
		<div style="height:745px;">
			...
			<form method="post">
			<br>
				<a href="editroute.php" style="margin-left:10%; font-size:18px;">New route Master</a>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							<tbody>
								<tr align="center" class="<?php echo $class?>">
									<td width="10%;"><?=$locncd?></td>
									<td width="50%;"><?=$locnnm?></td>
									<td width="12%;">
										<a href="editroute.php?locncd=<?=$locncd?>" class="button1" style="text-decoration:none">Edit</a>&nbsp;&nbsp;
										<a href="delroute.php?locncd=<?=$locncd?>" class="button1" style="text-decoration:none" onClick="javascript: return confirm('Are you SURE you wish to Delete?');">Delete</a>
									</td>
								</tr>
							</tbody>
							<?
